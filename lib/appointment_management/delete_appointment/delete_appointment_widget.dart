...
import 'delete_appointment_model.dart';
export 'delete_appointment_model.dart';

class DeleteAppointmentWidget extends StatefulWidget {
  const DeleteAppointmentWidget({
    Key? key,
    required this.vetAppointementDeleteRef,
  }) : super(key: key);

  final DocumentReference? vetAppointementDeleteRef;

  @override
  _DeleteAppointmentWidgetState createState() =>
      _DeleteAppointmentWidgetState();
}

class _DeleteAppointmentWidgetState extends State<DeleteAppointmentWidget> {
  late DeleteAppointmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteAppointmentModel());
