...
class _AddPetWidgetState extends State<AddPetWidget> {
  ...
  void initState() {
    ...
    _model.ownerNameController ??= TextEditingController();
    _model.ownerNameFocusNode ??= FocusNode();
    _model.ownerPhoneController ??= TextEditingController();
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Container(
                                          width: 370.0,
                                          child: TextFormField(
                                            controller: _model.breedController,
 ...
 */
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    width: 370.0,
                                    child: TextFormField(
                                      controller: _model.ownerPhoneController,
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await PetRecord.collection
                                          .doc()
                                          .set(createPetRecordData(
                                            petName:
                                                _model.petNameController.text,
                                            weight:
                                            ...
                                            ownerName:
                                                _model.ownerNameController.text,
                                            phoneNum: _model
