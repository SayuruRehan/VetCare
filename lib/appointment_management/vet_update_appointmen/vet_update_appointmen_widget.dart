...
import 'vet_update_appointmen_model.dart';
export 'vet_update_appointmen_model.dart';

class VetUpdateAppointmenWidget extends StatefulWidget {
  const VetUpdateAppointmenWidget({
    Key? key,
    required this.vetAppointmentRef,
  }) : super(key: key);

  final DocumentReference? vetAppointmentRef;

  @override
  _VetUpdateAppointmenWidgetState createState() =>
      _VetUpdateAppointmenWidgetState();
}

class _VetUpdateAppointmenWidgetState extends State<VetUpdateAppointmenWidget> {
  late VetUpdateAppointmenModel _model;
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            await widget.vetAppointmentRef!
                                                .update(
